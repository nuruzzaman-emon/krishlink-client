    ...
    <div className="bg-[#273c75] hover:bg-[#273c32] py-12 ">
      ...
      <div className="w-11/12 mx-auto">
        <div className="w-10/12 mx-auto text-white mt-5">
          ...
          <ul>
            <li className="list-disc hover:bg-[#3c6382]  md:text-lg rounded-lg ml-6 mb-3 p-4">
              <span className="text-lg md:text-xl font-bold">Establish Trust:</span> Our
            ...
            <li className="list-disc hover:bg-[#3c6382] md:text-lg rounded-lg ml-6 mb-3 p-4">
              <span className="text-lg md:text-xl font-bold"> Highlight Benefits: </span>
            ...
            <li className="list-disc hover:bg-[#3c6382] md:text-lg rounded-lg ml-6 mb-3 p-4">
              <span className="text-lg md:text-xl font-bold">Encourage Engagement:</span>{" "}
            ...
            <li className="list-disc hover:bg-[#3c6382] md:text-lg rounded-lg ml-6 mb-3 p-4">
              <span className="text-lg md:text-xl font-bold">Improve Conversion:</span>{" "}
